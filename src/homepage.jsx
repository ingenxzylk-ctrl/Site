...
const icons = {
  ...
  whatsapp:
    '<path d="M12 2.5a9.5 9.5 0 0 0-8.2 14.3L3 21.5l4.9-1.3A9.5 9.5 0 1 0 12 2.5z"/><path d="M9.2 8.4c.2-.5.4-.5.6-.5h.5c.2 0 .4 0 .55.4.2.55.7 1.7.75 1.85.05.15.1.3 0 .5-.1.2-.15.35-.3.5l-.4.45c-.15.15-.3.35-.1.65.2.3.8 1.25 1.7 2.05 1.15 1 2.05 1.3 2.35 1.45.3.15.5.1.65-.1.2-.2.8-.9 1-.1.2-.3.4-.25.7-.15.25.1 1.65.8 1.95.95.3.15.5.2.55.35.1.2.1 1.1-.25 1.55-.35.45-1.4 1.1-2.4 1.1-1 0-2.55-.35-4.6-2.25-2.45-2.2-3.95-4.6-4.15-4.95-.2-.35-1.1-1.6-1.1-2.95 0-1.35.7-2 .95-2.25z"/>',
